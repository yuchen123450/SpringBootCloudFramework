...
@Form.create()
class HFCTConfigure extends PureComponent {
    constructor(props) {
        super(props);
        let {
            intl: { formatMessage },
        ...
        this.state = {
            uhfGainList: [
                { key: 0, value: 0, name: '0dB' },
                { key: 1, value: 1, name: '-20dB' },
                { key: 1, value: 1, name: '-40dB' },
                { key: 1, value: 1, name: '-60dB' },
            ],
            gainModeList: [
...
export default injectIntl(HFCTConfigure);
